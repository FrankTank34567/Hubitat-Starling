...
metadata {
    definition(name: "Starling Weather", namespace: "starling", author: "AI-assisted (Claude/Anthropic)") {
        capability "TemperatureMeasurement"
        capability "RelativeHumidityMeasurement"

        attribute "structureName", "string"
...
def installed() {
    ...
    sendEvent(name: "structureName", value: "")
}
...
def parse(Map props) {
    ...
    if (props.containsKey("structureName")) {
        sendIfChanged("structureName", props.structureName?.toString() ?: "")
    }
}
